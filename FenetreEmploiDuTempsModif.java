...
public class FenetreEmploiDuTempsModif extends JFrame{
		...
		public FenetreEmploiDuTempsModif() {
			...
			this.pack();
			suivant.addActionListener(new ControleeeeSuivant(this));
		}
...
class ControleeeeSuivant implements ActionListener {
	
	FenetreEmploiDuTempsModif maFenetre;
	
	public ControleeeeSuivant(FenetreEmploiDuTempsModif uneFenetre){
