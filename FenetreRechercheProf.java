...
class ControleRecherche implements ActionListener {
	...
	public void actionPerformed(ActionEvent e){
		...
		if (resultat.size()==0) {
			jop = new JOptionPane();
			jop.showMessageDialog(null, "Il n'y a pas de professeur disponible, veuillez ré-effectuer votre recherche en changeant le jour et l'heure", "Attention", JOptionPane.WARNING_MESSAGE);
